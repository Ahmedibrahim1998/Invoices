                        ...
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                           aria-expanded="false">
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                    src="<?php echo e(URL::asset('assets/img/flags/us_flag.jpg')); ?>" alt="img"></span>
                            <div class="my-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            <a href="#" class="dropdown-item d-flex ">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        src="<?php echo e(URL::asset('assets/img/flags/french_flag.jpg')); ?>" alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        src="<?php echo e(URL::asset('assets/img/flags/germany_flag.jpg')); ?>" alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar ml-3 align-self-center bg-transparent"><img
                                        src="<?php echo e(URL::asset('assets/img/flags/italy_flag.jpg')); ?>" alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar ml-3 align-self-center bg-transparent"><img
                                        src="<?php echo e(URL::asset('assets/img/flags/russia_flag.jpg')); ?>" alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        src="<?php echo e(URL::asset('assets/img/flags/spain_flag.jpg')); ?>" alt="img"></span>
                                <div class="d-flex">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="  drop-img  cover-image  "
                                     data-image-src="<?php echo e(URL::asset('assets/img/faces/3.jpg')); ?>">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('assets/img/faces/2.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('assets/img/faces/9.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('assets/img/faces/12.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('assets/img/faces/5.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                    ...
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/6.jpg')); ?>"
                                                                class=""></div>
