...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        ...
        <a class="logo-icon mobile-logo icon-dark active" href="<?php echo e(url('/' . $page='index')); ?>"><img
                src="<?php echo e(URL::asset('assets/img/brand/favicon-white.png')); ?>" class="logo-icon dark-theme" alt="logo"></a>
    </div>
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" src="<?php echo e(URL::asset('assets/img/faces/6.jpg')); ?>"><span
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير المدفوعة')): ?>
                            <li><a class="slide-item" href="<?php echo e(url('/' . $page='Invoice_Paid')); ?>">الفواتير المدغوعة</a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير الغير مدفوعة')): ?>
                            <li><a class="slide-item" href="<?php echo e(url('/' . $page='Invoice_UnPaid')); ?>">الفواتير الغير
                                    المدغوعة</a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير المدفوعة')): ?>
                            <li><a class="slide-item" href="<?php echo e(url('/' . $page='Invoice_Partial')); ?>">الفواتير المدغوعة
                                    جزئيا</a></li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ارشيف الفواتير')): ?>
                            <li><a class="slide-item" href="<?php echo e(url('/' . ($page = 'Archive'))); ?>">ارشيف الفواتير</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('قائمة المستخدمين')): ?>
                            <li><a class="slide-item" href="<?php echo e(url('/' . $page='users')); ?>">قائمه المستخدمين</a></li>
                        <?php endif; ?>
