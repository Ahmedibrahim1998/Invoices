                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length="50">
                            ...
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(url('InvoicesDetails')); ?>/<?php echo e($invoice->id); ?>"><?php echo e($invoice->section->section_name); ?></a>
                                    </td>
                                    ...
                                    <td>
                                        <?php if($invoice->Value_Status == 1): ?>
                                            <span class="badge badge-success m-7"><?php echo e($invoice->Status); ?></span>
                                        <?php elseif($invoice->Value_Status == 2): ?>
                                            <span class="badge badge-danger m-7"><?php echo e($invoice->Status); ?></span>
                                        <?php else: ?>
                                            <span class="badge badge-warning m-7"><?php echo e($invoice->Status); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    data-toggle="dropdown" type="button">العمليات
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('حذف الفاتورة')): ?>
                                                    <a class="dropdown-item" href="#"
                                                       data-invoice_id="<?php echo e($invoice->id); ?>"
